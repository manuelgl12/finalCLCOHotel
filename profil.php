...
<div class="profile-container">
       ...
       ?>
        ...
        <a  href="./benutzerdaten.php"><button class="actionprofil">Benutzerdaten ändern</button></a>
        <a  href="./mytickets.php"><button class="actionprofil message">Tickets</button></a>
    </div>
